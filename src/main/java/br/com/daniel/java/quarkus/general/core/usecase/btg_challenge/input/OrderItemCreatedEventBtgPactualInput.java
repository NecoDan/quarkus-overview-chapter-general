...
public record OrderItemCreatedEventBtgPactualInput(@NotBlank(message = "produto é obrigatório") @JsonProperty("produto") String product,
    ...
    public OrderItemCreatedEventBtgPactualInput {
