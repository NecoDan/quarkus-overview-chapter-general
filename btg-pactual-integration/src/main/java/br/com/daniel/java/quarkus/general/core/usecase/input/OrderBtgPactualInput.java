...
public record OrderBtgPactualInput(@NotNull(message = "codigoPedido é obrigatório") @JsonProperty("codigoPedido") UUID orderId,
                                   @NotNull(message = "codigoCliente é obrigatório") @JsonProperty("codigoCliente") UUID customerId,
                                   @Valid @JsonProperty("itens") List<OrderItemBtgPactualInput> items
) {
    public OrderBtgPactualInput {
